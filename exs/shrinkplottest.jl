...
# ╔═╡ f90d33c2-10c3-11ec-1564-eb2bf01b65fb
begin 
	using MixedModels
...
# ╔═╡ 31a96ae9-e7d3-4693-ba3e-cfe62c5f3997
md"""
# Shrinkage plots

(1) Fit well-specified model and shrinkage plot

(2) Compare to over-parameterized model's shrinkage plot

(3) Understand shrinkage plots!! 

"""

# ╔═╡ 310fe3f8-235b-44db-9d0a-f9a1942b51fb
spr_critregion = CSV.read("/Users/kylamcconnell/Documents/GitHub/inddiff_experience/data/critregion_exp.txt", delim="\t", header = 1, DataFrame, stringtype=String);

# ╔═╡ a655327f-c91f-4be3-bf34-af6e3a1777ab
md"## Well-specified model"

# ╔═╡ cb4d4462-a3a2-4c26-ae74-85c8029d5633
begin
	cntrsts = merge(
...
formula_ftp2 = @formula (logRT  ~ 1 + FTP_lz * reading_exp_z * age_z * position + trial_number_z + word_number_z + length_z + prev_length_z + education +
               (1 + trial_number_z + length_z + prev_length_z | id) + 
               (1 + trial_number_z | w1) +
               (1 + trial_number_z | w2));

region_ftp = fit(MixedModel, formula_ftp2, spr_critregion, contrasts=cntrsts);
end

# ╔═╡ 68b4f951-7164-4bd6-8884-66dc88ad3715
shrinkageplot(region_ftp)

# ╔═╡ 056446ed-51bc-4cfd-8c6c-a73bff9141e0
qqcaterpillar(region_ftp)

# ╔═╡ c9da1432-3c11-462e-8022-3951d8178e4d
md"## Overspecified model"

# ╔═╡ 8ff6ea67-cfa6-4c24-b357-a36359623b1b
begin
...
# ╔═╡ dfb0e291-9c28-4aa1-b6eb-35e09541da24
shrinkageplot(maximal_ftp)
...
[[JellyMe4]]
deps = ["CategoricalArrays", "DataFrames", "Distributions", "GLM", "LinearAlgebra", "MixedModels", "RCall", "StatsBase", "StatsModels", "Tables"]
git-tree-sha1 = "81321d61edc5916530fc16f5008984c5d3946e8f"
